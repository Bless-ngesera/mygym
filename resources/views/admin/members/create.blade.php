<x-app-layout>
        ...
        <div class="flex items-center justify-between">
            ...
            <div class="flex flex-wrap items-center gap-2">
                <a href="{{ route('admin.members.index') }}"
                   class="px-3 py-2 bg-emerald-50 text-emerald-700 rounded-xl text-sm font-semibold hover:bg-emerald-100 transition-all duration-200 border border-emerald-200">
                    <span class="flex items-center gap-2">
                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M10 19l-7-7m0 0l7-7m-7 7h18"/>
                        </svg>
                        <span class="hidden sm:inline">Back to </span>Members
                    </span>
                </a>
    ...
    <aside id="adminSidebar"
        ...
        <nav class="flex-1 overflow-y-auto px-3 space-y-0.5 pb-2 custom-scrollbar">
            ...
            <a href="{{ route('admin.members.index') }}"
               class="flex items-center px-3 py-2.5 rounded-xl transition-all duration-200 group
               {{ request()->routeIs('admin.members.*') ? 'bg-indigo-600 text-white shadow-md' : 'bg-emerald-50 text-emerald-700' }}">
                <span class="flex items-center justify-center w-8 h-8 rounded-lg mr-3 flex-shrink-0
                    {{ request()->routeIs('admin.members.*') ? 'bg-white/20' : 'bg-emerald-100' }}">
                    <svg class="w-4 h-4 {{ request()->routeIs('admin.members.*') ? 'text-white' : 'text-emerald-600' }}" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <div class="bg-white/85 backdrop-blur-md border border-white/40 rounded-2xl shadow-lg overflow-hidden">
                        ...
                        <div class="px-6 py-5 border-b border-gray-100">
                            <div class="flex items-center gap-3">
                                ...
                                <div>
                                    <h2 class="text-xl font-bold text-gray-900">Create New Member</h2>
                                    <p class="text-sm text-gray-500 mt-0.5">Add a new member to your gym</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <form action="{{ route('admin.members.store') }}" method="POST" class="p-6">
                            ...
                            <div class="space-y-5">
                                ...
                                {{-- Info Alert --}}
                                <div class="bg-emerald-50/80 border border-emerald-100 rounded-xl p-4">
                                    <div class="flex items-start gap-3">
                                        ...
                                        <div class="text-sm text-emerald-800">
                                            <p class="font-medium">The member will be able to log in immediately with these credentials.</p>
                                            <p class="text-xs text-emerald-600 mt-1">They can change their password after first login.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="mt-8 flex items-center justify-end gap-3 pt-5 border-t border-gray-100">
                                ...
                                <button type="submit"
                                        class="px-5 py-2.5 bg-emerald-600 hover:bg-emerald-700 text-white rounded-xl text-sm font-semibold transition-all duration-200 shadow-md hover:shadow-lg flex items-center gap-2">
                                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5" d="M18 9v3m0 0v3m0-3h3m-3 0h-3m-2-5a4 4 0 11-8 0 4 4 0 018 0zM3 20a6 6 0 0112 0v1H3v-1z"/>
                                    </svg>
                                    Create Member
