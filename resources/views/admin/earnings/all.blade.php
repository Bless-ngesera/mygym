                            ...
                            <table class="min-w-full">
                                <thead>
                                    <tr class="bg-gray-50/80">
                                        <th class="hidden sm:table-cell px-5 py-3 text-left text-[11px] font-bold text-gray-500 uppercase tracking-wider">Reference</th>
                                        <th class="px-5 py-3 text-left text-[11px] font-bold text-gray-500 uppercase tracking-wider">Member</th>
                                        <th class="hidden md:table-cell px-5 py-3 text-left text-[11px] font-bold text-gray-500 uppercase tracking-wider">Instructor</th>
                                        <th class="px-5 py-3 text-left text-[11px] font-bold text-gray-500 uppercase tracking-wider">Class</th>
                                        <th class="hidden sm:table-cell px-5 py-3 text-left text-[11px] font-bold text-gray-500 uppercase tracking-wider">Payment</th>
                                        <th class="px-5 py-3 text-left text-[11px] font-bold text-gray-500 uppercase tracking-wider">Amount</th>
                                        <th class="hidden md:table-cell px-5 py-3 text-left text-[11px] font-bold text-gray-500 uppercase tracking-wider">Date</th>
                                    </tr>
                                </thead>
                                <tbody class="divide-y divide-gray-50">
                                    @forelse ($recentReceipts as $r)
                                        <tr class="hover:bg-indigo-50/30 transition-colors duration-150">
                                            <td class="hidden sm:table-cell px-5 py-3.5 text-sm font-mono text-gray-600">
                                                {{ $r->reference_number ?? '-' }}
                                            </td>
                                            ...
                                            <td class="hidden md:table-cell px-5 py-3.5 text-sm text-gray-600">
