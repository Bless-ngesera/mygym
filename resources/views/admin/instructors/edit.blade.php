        ...
        <div class="flex items-center justify-between">
            ...
            <div class="flex flex-wrap items-center gap-2">
                <a href="{{ route('admin.instructors.index') }}"
                   class="px-3 py-2 bg-indigo-50 text-indigo-700 rounded-xl text-sm font-semibold hover:bg-indigo-100 transition-all duration-200 border border-indigo-200">
                    <span class="flex items-center gap-2">
                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M10 19l-7-7m0 0l7-7m-7 7h18"/>
                        </svg>
                        <span class="hidden sm:inline">Back to </span>Instructors
                    </span>
                </a>
                <a href="{{ route('admin.dashboard') }}"
                   class="px-3 py-2 bg-gray-50 text-gray-700 rounded-xl text-sm font-semibold hover:bg-gray-100 transition-all duration-200 border border-gray-200">
                    <span class="flex items-center gap-2">
                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <main class="min-h-screen overflow-y-auto"
            ...
            <div class="p-4 md:p-6 lg:p-8">
                <div class="max-w-2xl mx-auto">
                    ...
                    <div class="bg-white/85 backdrop-blur-md border border-white/40 rounded-2xl shadow-lg overflow-hidden">
                        ...
                        <div class="px-6 py-5 border-b border-gray-100">
                            <div class="flex items-center gap-3">
                                ...
                                <div>
                                    <h2 class="text-xl font-bold text-gray-900">Edit Instructor</h2>
                                    <p class="text-sm text-gray-500 mt-0.5">Update instructor information</p>
                                </div>
                            </div>
                        </div>
                        ...
                        {{-- Error Messages --}}
                        @if($errors->any())
                            <div class="mx-6 mt-5 p-4 bg-red-50 border border-red-200 text-red-800 rounded-xl">
                        ...
                        {{-- Form --}}
                        <form action="{{ route('admin.instructors.update', $instructor->id) }}" method="POST" class="p-6">
                            @csrf
                            @method('PUT')
                            ...
                            <div class="space-y-5">
                                ...
                                <div>
                                    ...
                                    <div class="relative">
                                        ...
                                        <input type="text"
                                               ...
                                               required
                                               class="w-full pl-10 pr-4 py-2.5 bg-white/80 border border-gray-200 rounded-xl text-sm focus:ring-2 focus:ring-indigo-200 focus:border-indigo-400 transition-all placeholder-gray-400"
                                ...
                                {{-- Password Info Alert --}}
                                <div class="bg-amber-50/80 border border-amber-100 rounded-xl p-4">
                                    <div class="flex items-start gap-3">
                                        ...
                                        <div class="text-sm text-amber-800">
                                            <p class="font-medium">Password remains unchanged</p>
                                            <p class="text-xs text-amber-600 mt-1">To change password, use the reset password feature.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="mt-8 flex items-center justify-end gap-3 pt-5 border-t border-gray-100">
                                <a href="{{ route('admin.instructors.index') }}"
                                   class="px-5 py-2.5 bg-gray-50 hover:bg-gray-100 text-gray-700 rounded-xl text-sm font-semibold transition-all duration-200 border border-gray-200">
                                    Cancel
                                </a>
                                <button type="submit"
                                        class="px-5 py-2.5 bg-indigo-600 hover:bg-indigo-700 text-white rounded-xl text-sm font-semibold transition-all duration-200 shadow-md hover:shadow-lg flex items-center gap-2">
                                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <div class="mt-6 bg-white/85 backdrop-blur-md border border-white/40 rounded-2xl shadow-lg p-5">
                        <div class="flex items-center justify-between">
                            <div class="flex items-center gap-3">
                                <img src="https://ui-avatars.com/api/?name={{ urlencode($instructor->name) }}&background=4F46E5&color=fff&bold=true&size=64"
                                     alt="" class="w-12 h-12 rounded-xl ring-2 ring-indigo-200">
                                <div>
