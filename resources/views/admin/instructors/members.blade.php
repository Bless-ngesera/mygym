    ...
    <x-slot name="header">
        <div class="flex justify-between items-center">
            <h2 class="font-semibold text-xl text-gray-800 leading-tight">
                Members of {{ $instructor->name }}
            </h2>
            <a href="{{ route('admin.instructors.index') }}" class="px-4 py-2 bg-gray-600 text-white rounded-lg">Back to Instructors</a>
        </div>
    </x-slot>
                ...
                <div class="p-6">
                    ...
                    @else
                        <div class="text-center py-12">
                            <p class="text-gray-500">No members assigned to this instructor yet.</p>
                        </div>
                    @endif
                </div>
            </div>
