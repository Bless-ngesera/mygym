                ...
                <div class="max-w-3xl mx-auto">
                    ...
                    <div class="bg-white/85 backdrop-blur-md border border-white/40 rounded-2xl shadow-lg overflow-hidden">
                        ...
                        <div class="px-6 py-5 border-b border-gray-100">
                            <h2 class="text-xl font-bold text-gray-900">Register New Instructor</h2>
                            <p class="text-sm text-gray-500 mt-1">Add a new fitness instructor to your team</p>
                        </div>

                        {{-- Success Message --}}
                        @if(session('success'))
                            <div class="mx-6 mt-5 p-4 bg-emerald-50 border border-emerald-200 text-emerald-800 rounded-xl flex items-center gap-3">
                                ...
                                <div class="flex-1">
                                    ...
                                    <a href="{{ route('admin.instructors.index') }}" class="text-xs text-emerald-700 hover:text-emerald-900 underline inline-flex items-center gap-1 mt-1">
                                ...
                                <button type="button" class="text-emerald-600 hover:text-emerald-800" onclick="this.closest('div').style.display='none'">
                                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M6 18L18 6M6 6l12 12"/>
                                    </svg>
                                </button>
                        ...
                        {{-- Form --}}
                        <form action="{{ route('admin.instructors.store') }}" method="POST" class="p-6">
                            @csrf
                            ...
                            <div class="space-y-5">
                                ...
                                {{-- Info Alert --}}
                                <div class="bg-indigo-50/80 border border-indigo-100 rounded-xl p-4">
                                    <div class="flex items-start gap-3">
                                        ...
                                        <div class="text-sm text-indigo-800">
                                            <p class="font-medium">A random password will be generated and sent to the instructor's email.</p>
                                            <p class="text-xs text-indigo-600 mt-1">They can change it after their first login.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
