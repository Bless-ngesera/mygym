    ...
    <div class="py-6">
        <div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
            <div class="mb-4 flex justify-between items-center">
                <input id="instructor-search" type="search" placeholder="Search instructors..." class="w-1/3 px-3 py-2 border rounded-lg" />
                <div class="text-sm text-gray-600">Total: <span class="font-medium">{{ $instructors->count() }}</span></div>
            </div>
