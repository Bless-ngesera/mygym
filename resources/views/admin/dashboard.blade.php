                            ...
                            <table class="min-w-full">
                                <thead>
                                    <tr class="bg-gray-50/80">
                                        <th class="px-5 py-3 text-left text-[11px] font-bold text-gray-500 uppercase tracking-wider">Name</th>
                                        <th class="px-5 py-3 text-left text-[11px] font-bold text-gray-500 uppercase tracking-wider">Email</th>
                                        <th class="px-5 py-3 text-left text-[11px] font-bold text-gray-500 uppercase tracking-wider">Joined</th>
                                        <th class="px-5 py-3 text-left text-[11px] font-bold text-gray-500 uppercase tracking-wider">Actions</th>
                                    </tr>
                                </thead>
                                        ...
                                        <tr class="hover:bg-indigo-50/30 transition-colors duration-150">
                                            <td class="px-5 py-3.5 whitespace-nowrap">
                                                <div class="flex items-center gap-3">
                                                    <img src="https://ui-avatars.com/api/?name={{ urlencode($instructor->name) }}&background=4F46E5&color=fff&bold=true" alt="" class="w-8 h-8 rounded-lg shadow-sm">
                                                    <span class="text-sm font-semibold text-gray-800">{{ $instructor->name }}</span>
                                                </div>
                                            </td>
                                            <td class="px-5 py-3.5 whitespace-nowrap text-sm text-gray-600">{{ $instructor->email }}</td>
                                            <td class="px-5 py-3.5 whitespace-nowrap">
                                            ...
                                            <td class="px-5 py-3.5 whitespace-nowrap">
                                                <a href="{{ route('admin.instructors.edit', $instructor->id) }}"
                                                   class="inline-flex items-center text-xs font-semibold text-indigo-600 hover:text-indigo-800 bg-indigo-50 hover:bg-indigo-100 px-2.5 py-1 rounded-lg transition-colors mr-2">Edit</a>
                                                <form action="{{ route('admin.instructors.destroy', $instructor->id) }}" method="POST" class="inline-block delete-form">
                                                    @csrf
                                                    @method('DELETE')
                                                    <button type="submit" class="inline-flex items-center text-xs font-semibold text-red-600 hover:text-red-800 bg-red-50 hover:bg-red-100 px-2.5 py-1 rounded-lg transition-colors">Delete</button>
                                                </form>
                                            </td>
                                        </tr>
                                    @empty
