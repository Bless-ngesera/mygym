        ...
        <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-3">
            ...
            <div class="flex flex-wrap gap-2">
                <a href="{{ route('instructor.upcoming') }}"
                   class="px-3 sm:px-4 py-2 bg-purple-100 text-purple-700 rounded-xl text-sm font-semibold hover:bg-purple-200 transition-all duration-200">
                    Upcoming
                </a>
                <a href="{{ route('instructor.classes') }}"
                   class="px-3 sm:px-4 py-2 bg-indigo-100 text-indigo-700 rounded-xl text-sm font-semibold hover:bg-indigo-200 transition-all duration-200">
                    My Classes
                </a>
            </div>
        </div>
