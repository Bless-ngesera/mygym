    ...
    <x-slot name="header">
        <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-3">
            <div>
                ...
                <p class="text-sm text-gray-500 dark:text-gray-400 mt-1">Manage your scheduled fitness classes</p>
            </div>
                ...
                <div class="p-6 md:p-8">
                    @forelse ($scheduledClasses as $class)
                        <div class="py-6 border-b border-gray-100 last:border-b-0 hover:bg-purple-50/30 transition-all duration-200 rounded-xl px-4 -mx-4">
                            <div class="flex flex-col md:flex-row gap-6 justify-between items-start md:items-center">
                                ...
                                <div class="flex-1">
                                    <div class="flex items-center gap-3 mb-2">
                                        ...
                                        <div>
                                            <p class="text-xl font-bold text-black-700 dark:text-black">{{ $class->classType->name }}</p>
                                            <div class="flex items-center gap-2 text-sm text-black-400 dark:text-black-300">
                                                <span>{{ $class->classType->minutes }} minutes</span>
                                                <span>•</span>
                                                <span class="font-semibold text-emerald-800 dark:text-emerald-600">UGX {{ number_format($class->price ?? 0, 0) }}</span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="text-left md:text-right">
                                    <div class="flex items-center gap-4 md:block">
                                        <div>
                                            <p class="text-2xl font-bold text-purple-800 dark:text-purple-500">{{ $class->date_time->format('g:i a') }}</p>
                                            <p class="text-sm text-gray-600 dark:text-gray-500">{{ $class->date_time->format('l, jS M Y') }}</p>
                                        </div>
                                    </div>
                                </div>

                                <!-- Actions - Three buttons: View Details, Edit, Cancel -->
                                <div class="flex gap-2 w-full md:w-auto">
                                    <!-- View Details Button (Blue) -->
                                    <a href="{{ route('instructor.schedule.show', $class->id) }}"
                                       class="flex-1 md:flex-none px-4 py-2 bg-blue-50 hover:bg-blue-100 text-blue-700 rounded-lg text-sm font-semibold transition-all duration-200 flex items-center justify-center gap-1 border border-blue-200">
                                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            ...
                            <!-- Booked Members Count - Clickable with hover effect -->
                            <div class="mt-3 pt-3 border-t border-gray-100 dark:border-gray-700">
                                <a href="{{ route('instructor.schedule.show', $class->id) }}" class="group block">
                                    <div class="flex items-center gap-2 text-sm text-gray-500 dark:text-gray-400 hover:text-purple-600 dark:hover:text-purple-400 transition-colors">
                                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    @empty
                        <div class="text-center py-12">
                            ...
                            <p class="text-gray-500 dark:text-gray-400 text-lg mb-2">No upcoming classes</p>
                            <p class="text-gray-400 dark:text-gray-500 text-sm mb-4">You don't have any classes scheduled yet</p>
                            <a href="{{ route('instructor.create') }}"
